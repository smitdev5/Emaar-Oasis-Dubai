...
const carouselItems = [
  { id: 1, text1: '10 Mins', text2: 'Sheikh Zayed Road' },
  { id: 2, text1: '15 Mins', text2: 'Dubai International Airport' },
  { id: 3, text1: '20 Mins', text2: 'Downtown Dubai' },
  { id: 4, text1: '20 Mins', text2: 'Dubai Mall / Burj Khalifa' },
  { id: 5, text1: '20 Mins', text2: 'Dubai Creek Harbour' },
...
const Invest = () => {
  ...
  return (
    <div className="relative w-full py-44 flex flex-col justify-center items-center font-inter text-white overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('../Assets/gallery3.webp')" }}>
